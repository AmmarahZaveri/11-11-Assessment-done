...
//I didn't know whether I should leave it ike this or console.log it
//Since the instructions said to "return"
...
const canWeDeliverTwo = (zipCode) => {
  ...
  //I console.loged it to make sure it worked.
...
*/
  ...
  const newDeals = JSON.parse(
    JSON.stringify(deals).replace('15', '10')
  );
  console.log(newDeals);
  //I tried many different ways to do this but 
  //I kept getting an error that replace wasn't a function
  //I found a way to do it with JSON but I'm still
...
const newdeals = JSON.parse(
    JSON.stringify(deals).replace('March', 'April')
  );
  console.log(newdeals);
  //DONE